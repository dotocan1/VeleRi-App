(self["webpackChunkveleri_app"] = self["webpackChunkveleri_app"] || []).push([[54],{
...
;// CONCATENATED MODULE: ./node_modules/@quasar/app/lib/webpack/loader.js.transform-quasar-imports.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-2.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@quasar/app/lib/webpack/loader.vue.auto-import-quasar.js??ruleSet[0].use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/pages/Administration.vue?vue&type=template&id=f4c7e156&scoped=true


const _withId = /*#__PURE__*/(0,runtime_core_esm_bundler/* withScopeId */.HX)("data-v-f4c7e156");

(0,runtime_core_esm_bundler/* pushScopeId */.dD)("data-v-f4c7e156");
...
;// CONCATENATED MODULE: ./src/pages/Administration.vue?vue&type=template&id=f4c7e156&scoped=true
  ...
  methods: {
    ...
    DownloadToDevice(fileurl) {
      ...
      xhr.onload = function () {
        ...
        const filename = `${(0,uid/* default */.Z)()}.png`;
        const DataBlob = blob;
        window.resolveLocalFileSystemURL(folderpath, function (dir) {
          dir.getFile(filename, {
            ...
            file.createWriter(function (fileWriter) {
              fileWriter.write(DataBlob); // Download je bio uspjesan
    ...
    submit() {
      this.$q.loadingBar.start(); // postavljanje slike u firebase storage

      const storageRef = this.$storage.ref();
      const professorsRef = storageRef.child(`professors/${(0,uid/* default */.Z)()}`); // pokrece se ako nije uploadana niti jedna slika pa se time ne azurira postojeci link na sliku
      ...
      if (this.pictureUpload === null) {
        ...
        // pokrece se ako je uploadana slika u aplikaciji te se time i azurira link koji vodi na sliku
...
Administrationvue_type_script_lang_js.__scopeId = "data-v-f4c7e156"
